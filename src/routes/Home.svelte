...
<div class="overview-image-wrapper">
  <img
    src="https://assets.vestate.io/lnt-ahana/brochure/overview/FRONT%20FACEING.webp"
    alt="Overview"
      ...
      <div class={!$isInteriorUnitDataMinimized ? "block" : "hidden"}>
        <div class="no-hovers pt-3">
          <div class="inner-btn-group">
            <button
              on:click={() => {
                exteriorImagesSeq.set("lnt-ahana");
                pageNumber.set(1);
              }}
              class={`inner-modal-btn ${$exteriorImagesSeq == "lnt-ahana" ? "active" : ""}`}
              id="master-brochure-download">L&T Ahana</button
            >
            <button
              on:click={() => {
