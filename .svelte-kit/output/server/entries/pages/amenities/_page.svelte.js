...
function _page($$payload, $$props) {
  ...
  $$payload.out += ` <div id="amenities-image-container" class="amenities-image-wrapper svelte-uq54zb"><!--[-->`;
  if (store_get($$store_subs ??= {}, "$currentImage", currentImage)) {
    $$payload.out += `<img${attr("src", store_get($$store_subs ??= {}, "$currentImage", currentImage), false)} alt="Amenity" class="amenities-static-image svelte-uq54zb">`;
    $$payload.out += "<!--]-->";
  } else {
    $$payload.out += `<img${attr("src", amenityImages[amenitiesList[0].id], false)} alt="Amenity" class="amenities-static-image svelte-uq54zb">`;
    $$payload.out += "<!--]!-->";
  }
  $$payload.out += `</div>`;
  if ($$store_subs)
